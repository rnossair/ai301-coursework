...
I'm a student with experience in fullstack web development (ReactJs/NextJs, expressJs) with some foundational knowledge of AI Engineering (Rag Pipelines, Agent loops, Agent tools, MCP). I am somewhat comfortable in Python, Typescript, Javascript, Java, C. I prefer working on issues with relation to AI Engineering as its a field im piovting towards.